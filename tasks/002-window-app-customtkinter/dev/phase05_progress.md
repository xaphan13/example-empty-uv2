...
**Часть A** — `main_window_ctk.py`: семантическая проверка после
...
- **Ничего другого в классе не трогал**: ни bind'ы, ни hover, ни
  ...
  рассинхрона с `main_window_ctk.py` нет.
...
- `window_app.ui`: 461 → 455 строк (-6 строк: 5 wraplength + 1 лишний
  перевод строки).
- `main_window_ctk.py`: без правок (264 строки, переименование сделано
  в фазе 2).
